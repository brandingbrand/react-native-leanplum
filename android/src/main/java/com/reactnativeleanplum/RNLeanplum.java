...
public class RNLeanplum extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void setDeviceLocation(double latitude, double longitude, String type) {
      Location location = new Location("");
      location.setLatitude(latitude);
      location.setLongitude(longitude);

      Leanplum.setDeviceLocation(location, LeanplumLocationAccuracyType.valueOf(type));
    }
